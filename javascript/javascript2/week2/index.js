...
function showMovieTitleRatingMorethan6Generator() {
...
showMovieTitleRatingMorethan6Button.addEventListener(
  "click",
  showMovieTitleRatingMorethan6Generator
);
/*
...
function show() {
  ...
  const averageMoives = document.createElement("div");
  ...
  averageMoives.innerHTML = `averageMovies: ${totalNumberGAB["averageMovies"]}`;
  badMovies.innerHTML = `badMovies: ${totalNumberGAB["badMovies"]}`;
  console.log(totalNumberGAB);
  showFX.append(goodMovies);
  showFX.append(averageMoives);
